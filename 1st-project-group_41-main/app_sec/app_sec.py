...
def user_profiles():
    if request.method == "POST":
        ...
        if file and allowed_file(file.filename): # TODO for app_sec: not safe per the docs!!  allowed_file(file.filename) should be used. check: https://flask.palletsprojects.com/en/1.1.x/patterns/fileuploads/
